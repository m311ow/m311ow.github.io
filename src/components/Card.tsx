...
const styles = {
  cardContainer: "my-6",
  titleLink:
    "text-skin-accent font-medium text-xl underline-offset-4 decoration-dashed focus-visible:no-underline focus-visible:underline-offset-0 inline-block",
  titleHeading: "font-medium text-xl decoration-dashed hover:underline",
};
